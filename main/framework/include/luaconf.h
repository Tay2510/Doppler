...
#define LUA_USE_ULONGJMP 1
#define LUA_USE_POSIX_SIGNAL 1
#define LUA_USE_DLOPEN 1
#define LUA_USE_ISATTY 1
#define LUA_USE_MKSTEMP 1
#define LUA_USE_POPEN 1
/* #undef LUA_USE_READLINE */
/* #undef LUA_USE_READLINE_EVENT_HOOK */
...
/* ================================================================ */
/* ================================================================ */
/*  THE FOLLOWING IS COPIED VERBATIM FROM LUA-5.1.3/SRC/LUACONF.H   */
/* ================================================================ */
/* ================================================================ */
/* ================================================================ */
...
/*
** $Id: luaconf.h.in,v 1.4 2008-08-08 16:15:05 leonb Exp $
